...
class PacketHeaderError(Exception):
    ...
    def __init__(self, packet):
        super().__init__(self,
                         f'Получен пакет с неверным заголовком - {packet}.')


class PacketFooterError(Exception):
    def __init__(self, packet):
        super().__init__(self,
                         f'Получен пакет с неверным окончанием - {packet}.')
...
class BCDValueError(Exception):
    def __init__(self, data):
        super().__init__(
            self,
            f'Не удалось преобразовать значение {data} в целое число.'
        )
...
class TimeValueError(Exception):
    def __init__(self, data):
        super().__init__(
            self,
            f'Не удалось преобразовать значение {data} во временной интервал.'
        )
